...
void lift_camera_up(GalbotMotion& motion, const Pose& object_pose, const std::string& target_chain){
    int retry_cnt = 3;
    ...
    target_ee_pose[2] = object_pose.position.z - 0.1;
...
int main(){
    ...
    try{
        ...
        lift_camera_up(motion, object_goal_pose, target_chain);
