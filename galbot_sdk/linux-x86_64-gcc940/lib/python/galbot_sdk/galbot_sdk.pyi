...
import numpy.typing
import typing
__all__: list[str] = ['AudioData', 'CLOSE_TO_OBSTACLE', 'COLLISION', 'COMM_DISCONNECTED', 'CYLINDER', 'CollisionCheckOption', 'ControlStatus', 'DATA_FETCH_FAILED', 'DepthData', 'DetectionAndSegmentationResult', 'DetectionResult', 'DexHandType', 'DexhandState', 'EUCLIDEAN_DISTANCE', 'EffortInfo', 'Error', 'ErrorInfo', 'FAILED', 'FAULT', 'FOUNDATION_STEREO', 'ForceData', 'FrameTriad', 'G1ControllerName', 'G1JointGroup', 'GalbotMotion', 'GalbotNavigation', 'GalbotOneFoxtrotSensor', 'GalbotPerception', 'GalbotRobot', 'GripperState', 'GroupCommand', 'Header', 'IKSolverConfig', 'INIT_FAILED', 'INTERRUPTED', 'INVALID_INPUT', 'IN_PROGRESS', 'ImuData', 'JOINT', 'JointCommand', 'JointState', 'JointStateMessage', 'JointStates', 'KinematicsBoundary', 'LIGHT_STEREO', 'LINE', 'LidarData', 'LineTrajCheckPrimitive', 'LogLevel', 'MachineType', 'MotionPlanConfig', 'MotionStatus', 'NavigationTaskSnapshot', 'NavigationTaskStatus', 'OCCUPIED', 'OdomData', 'POSE', 'PUBLISH_FAIL', 'Parameter', 'PerceptionModule', 'Point', 'Point2d', 'PointField', 'PointFieldDataType', 'Pose', 'Pose2d', 'PoseState', 'PrimitiveType', 'Quaternion', 'RADIAN_DISTANCE', 'RANDOM_PROGRESSIVE_SEED', 'RANDOM_SEED', 'ROBOT_STATES', 'RUNNING', 'RgbData', 'RobotStates', 'RobotStatesType', 'S1ControllerName', 'S1JointGroup', 'STATUS_NUM', 'STOPPED_UNREACHED', 'SUCCESS', 'SUCTION_ACTION_STATE', 'SamplerConfig', 'SeedType', 'SensorType', 'SingoriXTarget', 'StateCheckType', 'SuctionCupState', 'SyncedObservation', 'TARGET_DATA_DEFAULT', 'TARGET_DATA_FRAME_POSE', 'TARGET_DATA_FRAME_TWIST', 'TARGET_DATA_FRAME_WRENCH', 'TARGET_DATA_JOINT_ACCELERATION', 'TARGET_DATA_JOINT_EFFORT', 'TARGET_DATA_JOINT_POSITION', 'TARGET_DATA_JOINT_VELOCITY', 'TARGET_DATA_NONE', 'TARGET_TYPE_APPEND', 'TARGET_TYPE_CLEAR', 'TARGET_TYPE_DEFAULT', 'TARGET_TYPE_NONE', 'TARGET_TYPE_OVERRIDE', 'TARGET_TYPE_PREPENDNOW', 'TARGET_TYPE_PROVERRIDE', 'TARGET_TYPE_TOUCH', 'TIMEOUT', 'TIMEOUT_AND_EXACT_SOLUTION', 'TargetConfig', 'TargetGroupTrajectory', 'TargetSampling', 'TargetTaskTrajectory', 'TaskCommand', 'TaskHandle', 'TerminationConditionType', 'Timestamp', 'Trajectory', 'TrajectoryControlStatus', 'TrajectoryFeasibilityCheckOption', 'TrajectoryPlanConfig', 'TrajectoryPoint', 'Twist', 'UNKNOWN', 'UNSUPPORTED_FUNCRION', 'USER_DEFINED_SEED', 'UltrasonicData', 'UltrasonicType', 'Vector3', 'WBCException', 'Waypoint', 'WaypointParams', 'Wrench', 'check_motion_status', 'create_joint_state', 'create_parameter', 'create_pose_state']
class AudioData:
    """
...
class Error:
    ...
    def __init__(self, commpent: str, error_code: typing.SupportsInt, description: str) -> None:
        ...
    @property
...
class GalbotNavigation:
    ...
    def move_straight_to(self, goal_pose: typing.Annotated[numpy.typing.ArrayLike, numpy.float64], is_blocking: bool = True, timeout: typing.SupportsFloat = 8) -> tuple:
        ...
        """
    def navigate_along_trajectory(self, waypoints: collections.abc.Sequence[Pose], frame_id: str = 'map', speed_ratio: typing.SupportsFloat = 1.0, enable_collision_check: bool = True) -> TaskHandle:
        """
        ...
        """
    def navigate_through_waypoints(self, waypoints: collections.abc.Sequence[Waypoint], frame_id: str = 'map', enable_collision_check: bool = True) -> TaskHandle:
        """
                            ...
                            Returns:
                                TaskHandle: Submitted task id, request result, and message.
        """
    def navigate_to_goal(self, goal_pose: typing.Annotated[numpy.typing.ArrayLike, numpy.float64], enable_collision_check: bool = True, is_blocking: bool = False, timeout: typing.SupportsFloat = 8, omni_plan: bool = False) -> tuple:
        """
        ...
        """
    def navigate_to_goal_v2(self, goal_pose: typing.Annotated[numpy.typing.ArrayLike, numpy.float64], max_vel: typing.Annotated[numpy.typing.ArrayLike, numpy.float64], pose_frame: str = 'map', enable_collision_check: bool = True, is_blocking: bool = False, timeout: typing.SupportsFloat = 5.0, omni_plan: bool = False) -> tuple:
        """
                            ...
                            Returns:
                                tuple: (success: bool, status_string: str)
                                    ...
                                    - status_string: Status string (SUCCESS, FAIL, TIMEOUT, etc.).
        """
    def navigate_with_velocity(self, vx: typing.SupportsFloat, vy: typing.SupportsFloat, vyaw: typing.SupportsFloat, duration_s: typing.SupportsFloat = 3.0, enable_collision_check: bool = True) -> tuple:
        """
    ...
    def remove_bounding_box(self, box_tag: typing.SupportsInt) -> tuple:
        """
                            ...
                            Returns:
                                tuple: (success: bool, status_string: str)
        """
    def set_navigation_arrival_threshold(self, threshold: typing.Annotated[numpy.typing.ArrayLike, numpy.float64]) -> tuple:
        """
                            ...
                            Returns:
                                tuple: (success: bool, status_string: str)
        """
    def set_navigation_kinematics_limits(self, vel_limit: typing.Annotated[numpy.typing.ArrayLike, numpy.float64], acc_limit: typing.Annotated[numpy.typing.ArrayLike, numpy.float64], jerk_limit: typing.Annotated[numpy.typing.ArrayLike, numpy.float64]) -> tuple:
        """
                            ...
                            Returns:
                                tuple: (success: bool, status_string: str)
        """
    def set_navigation_target(self, target: Pose, frame: str = 'map', speed_ratio: typing.SupportsFloat = 1.0, enable_collision_check: bool = True) -> TaskHandle:
        """
    ...
    def set_navigation_timeout(self, timeout_s: typing.SupportsFloat) -> tuple:
        """
                            ...
                            Returns:
                                tuple: (success: bool, status_string: str)
        """
    def set_navigation_velocity_limit(self, vel_limit: typing.Annotated[numpy.typing.ArrayLike, numpy.float64]) -> tuple:
        """
...
class GalbotRobot:
        ...
        """
                    ...
                    Returns:
                        dict: Dictionary containing point cloud data fields and binary point data.
                            Returns empty dictionary on failure.
        """
    def get_log_information(self, timewindow_s: typing.SupportsInt, log_level: LogLevel) -> dict:
        """
                    Get log information.
    ...
    def get_suction_cup_state(self, end_effector: str) -> SuctionCupState:
        ...
        """
    def get_synced_observation(self, cameras: collections.abc.Sequence[SensorType], with_joint_state: bool = True) -> SyncedObservation:
        """
    ...
    def get_wbc_end_effector_poses(self) -> dict[str, list[float]]:
        ...
        """
    def init(self, enable_sensor_set: collections.abc.Set[SensorType] = ..., enable_sync_mode: bool = False) -> bool:
        """
    ...
    def set_base_pose(self, base_pose: Pose, is_blocking: bool = True, timeout_s: typing.SupportsFloat = 15.0) -> ControlStatus:
        """
    ...
    def set_base_pose(self, x: typing.SupportsFloat, y: typing.SupportsFloat, yaw: typing.SupportsFloat, frame_id: str, reference_frame_id: str, time_from_start_s: typing.SupportsFloat, is_blocking: bool = True, timeout_s: typing.SupportsFloat = 15.0) -> ControlStatus:
        """
    ...
    def set_dexhand_command(self, end_effector: str, dexhand_command: collections.abc.Sequence[JointCommand], dexhand_type: DexHandType = ..., is_blocking: bool = True) -> ControlStatus:
        ...
        """
    def set_end_effector_command(self, poses: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]], end_effector_frames: collections.abc.Sequence[str], reference_frames: collections.abc.Sequence[str] = []) -> ControlStatus:
        """
                    ...
                    Returns:
                        ControlStatus: Command publishing result.
        """
    def set_gripper_command(self, end_effector: str, width_m: typing.SupportsFloat, velocity_mps: typing.SupportsFloat = 0.03, effort: typing.SupportsFloat = 5, is_blocking: bool = True) -> ControlStatus:
        """
                    Set gripper command.
                    ...
                    Returns:
                        ControlStatus: Command execution/sending result.
        """
    def set_joint_commands(self, joint_commands: collections.abc.Sequence[JointCommand], joint_groups: collections.abc.Sequence[str] = [], joint_names: collections.abc.Sequence[str] = [], time_from_start_s: typing.SupportsFloat = 0.0) -> ControlStatus:
        """
                    Set joint commands.
    ...
    def set_joint_positions(self, joint_positions: collections.abc.Sequence[typing.SupportsFloat], joint_groups: collections.abc.Sequence[str] = [], joint_names: collections.abc.Sequence[str] = [], is_blocking: bool = True, speed_rad_s: typing.SupportsFloat = 0.2, timeout_s: typing.SupportsFloat = 15.0) -> ControlStatus:
        ...
        """
    def set_suction_cup_command(self, end_effector: str, activate: bool) -> ControlStatus:
        """
    ...
    def zero_whole_body_and_base(self, base_zero_pose: Pose, is_blocking: bool = True, leg_head_speed_rad_s: typing.SupportsFloat = 0.2, leg_head_timeout_s: typing.SupportsFloat = 15.0, params: Parameter = None) -> tuple[MotionStatus, ControlStatus]:
        """
                    One-key zero: move whole-body joints to zero and base to zero pose.
        """
     
    def zero_whole_body_and_base(self, frame_id: str = 'odom', reference_frame_id: str = 'odom', is_blocking: bool = True, leg_head_speed_rad_s: typing.SupportsFloat = 0.2, leg_head_timeout_s: typing.SupportsFloat = 15.0, params: Parameter = None) -> tuple[MotionStatus, ControlStatus]:
        """
...
class IKSolverConfig:
    ...
    def set_enable_collision_check_log(self, enable: bool) -> None:
        ...
    def set_rotation_eps(self, eps: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"]) -> None:
        ...
    def set_seed_type(self, type: SeedType) -> None:
        ...
    def set_translation_eps(self, eps: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"]) -> None:
        ...
class ImuData:
    """
    IMU data
...
class KinematicsBoundary:
    ...
    def print(self) -> None:
        ...
    def set_acc_lower_limit(self, limits: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    def set_acc_upper_limit(self, limits: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    def set_chain_name(self, name: str) -> None:
        ...
    def set_jerk_lower_limit(self, limits: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    def set_jerk_upper_limit(self, limits: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    def set_lower_limit(self, limits: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    def set_upper_limit(self, limits: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    def set_vel_lower_limit(self, limits: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    def set_vel_upper_limit(self, limits: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
class LidarData:
    """
...
class MachineType:
    ...
    __members__: typing.ClassVar[dict[str, MachineType]]  # value = {'G1': <MachineType.G1: 0>, 'S1': <MachineType.S1: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class MotionPlanConfig:
    ...
    def set_collision_check_option(self, option: CollisionCheckOption) -> None:
        ...
    def set_feasibility_boundary(self, boundary: collections.abc.Sequence[KinematicsBoundary]) -> None:
        ...
    def set_hard_joint_limit(self, boundary: collections.abc.Sequence[KinematicsBoundary]) -> None:
        ...
    def set_ik_joint_limit(self, boundary: collections.abc.Sequence[KinematicsBoundary]) -> None:
        ...
    def set_ik_solver_config(self, config: IKSolverConfig) -> None:
        ...
    def set_line_traj_check_primitive(self, primitive: LineTrajCheckPrimitive) -> None:
        ...
    def set_revert_ik_joint_limit(self, flag: bool) -> None:
        ...
    def set_revert_ik_joint_limit_chains(self, chains: collections.abc.Sequence[str]) -> None:
        ...
    def set_sampler_config(self, config: SamplerConfig) -> None:
        ...
    def set_sampler_joint_limit(self, boundary: collections.abc.Sequence[KinematicsBoundary]) -> None:
        ...
    def set_trajectory_feasibility_check_option(self, option: TrajectoryFeasibilityCheckOption) -> None:
        ...
...
class NavigationTaskStatus:
    ...
    Members:
      ...
      CLOSE_TO_OBSTACLE
    """
    CLOSE_TO_OBSTACLE: typing.ClassVar[NavigationTaskStatus]  # value = <NavigationTaskStatus.CLOSE_TO_OBSTACLE: 7>
    COLLISION: typing.ClassVar[NavigationTaskStatus]  # value = <NavigationTaskStatus.COLLISION: 6>
    FAILED: typing.ClassVar[NavigationTaskStatus]  # value = <NavigationTaskStatus.FAILED: 3>
    INTERRUPTED: typing.ClassVar[NavigationTaskStatus]  # value = <NavigationTaskStatus.INTERRUPTED: 4>
    OCCUPIED: typing.ClassVar[NavigationTaskStatus]  # value = <NavigationTaskStatus.OCCUPIED: 5>
...
class OdomData:
    ...
    def angular_velocity(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"]) -> None:
        ...
    @property
    ...
    def linear_velocity(self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"]) -> None:
        ...
    @property
...
class Parameter:
    ...
    def joint_state(self) -> dict[str, list[float]]:
        ...
    @joint_state.setter
    def joint_state(self, arg0: collections.abc.Mapping[str, collections.abc.Sequence[typing.SupportsFloat]]) -> None:
        ...
    @property
...
class Pose2d:
    ...
    def __init__(self, x: typing.SupportsFloat = 0.0, y: typing.SupportsFloat = 0.0, theta: typing.SupportsFloat = 0.0) -> None:
        ...
    @property
...
class RobotStates:
    ...
    def set_base_state(self, base_pose: Pose) -> None:
        ...
    def set_whole_body_joint(self, joint_positions: collections.abc.Sequence[typing.SupportsFloat]) -> None:
        ...
    @property
...
class SamplerConfig:
    ...
    def set_state_check_type(self, type: StateCheckType) -> None:
        ...
    def set_termination_condition_type(self, type: TerminationConditionType) -> None:
        ...
class SeedType:
    """
    Members:
...
class SingoriXTarget:
    ...
    def target_group_trajectory_map(self, arg0: collections.abc.Mapping[str, TargetGroupTrajectory]) -> None:
        ...
    @property
    ...
    def target_task_trajectory_map(self, arg0: collections.abc.Mapping[str, TargetTaskTrajectory]) -> None:
        ...
...
class SyncedObservation:
    ...
    def depth_data_map(self, arg0: collections.abc.Mapping[SensorType, DepthData]) -> None:
        ...
    @property
    def joint_state(self) -> JointStateMessage:
        """
    ...
    def rgb_data_map(self) -> dict[SensorType, RgbData]:
        ...
        """
    @rgb_data_map.setter
    def rgb_data_map(self, arg0: collections.abc.Mapping[SensorType, RgbData]) -> None:
        ...
class TargetConfig:
    """
...
class TargetSampling:
    ...
    """
    TARGET_SAMPLING_B_SPLINES: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_B_SPLINES: 7>
    TARGET_SAMPLING_CUBIC_SPLINES: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_CUBIC_SPLINES: 5>
    TARGET_SAMPLING_CUSTOM: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_CUSTOM: 15>
    TARGET_SAMPLING_DEFAULT: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_DEFAULT: 0>
    TARGET_SAMPLING_DIRECT_PASS: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_DIRECT_PASS: 1>
    TARGET_SAMPLING_LINEAR_INTERPOLATE: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_LINEAR_INTERPOLATE: 2>
    TARGET_SAMPLING_QUINTIC_SPLINES: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_QUINTIC_SPLINES: 6>
    TARGET_SAMPLING_S_CURVE_PROFILE: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_S_CURVE_PROFILE: 4>
    TARGET_SAMPLING_TRAPEZOIDAL_PROFILE: typing.ClassVar[TargetSampling]  # value = <TargetSampling.TARGET_SAMPLING_TRAPEZOIDAL_PROFILE: 3>
    __members__: typing.ClassVar[dict[str, TargetSampling]]  # value = {'TARGET_SAMPLING_DEFAULT': <TargetSampling.TARGET_SAMPLING_DEFAULT: 0>, 'TARGET_SAMPLING_DIRECT_PASS': <TargetSampling.TARGET_SAMPLING_DIRECT_PASS: 1>, 'TARGET_SAMPLING_LINEAR_INTERPOLATE': <TargetSampling.TARGET_SAMPLING_LINEAR_INTERPOLATE: 2>, 'TARGET_SAMPLING_TRAPEZOIDAL_PROFILE': <TargetSampling.TARGET_SAMPLING_TRAPEZOIDAL_PROFILE: 3>, 'TARGET_SAMPLING_S_CURVE_PROFILE': <TargetSampling.TARGET_SAMPLING_S_CURVE_PROFILE: 4>, 'TARGET_SAMPLING_CUBIC_SPLINES': <TargetSampling.TARGET_SAMPLING_CUBIC_SPLINES: 5>, 'TARGET_SAMPLING_QUINTIC_SPLINES': <TargetSampling.TARGET_SAMPLING_QUINTIC_SPLINES: 6>, 'TARGET_SAMPLING_B_SPLINES': <TargetSampling.TARGET_SAMPLING_B_SPLINES: 7>, 'TARGET_SAMPLING_CUSTOM': <TargetSampling.TARGET_SAMPLING_CUSTOM: 15>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
def create_pose_state() -> PoseState:
    ...
    """
CLOSE_TO_OBSTACLE: NavigationTaskStatus  # value = <NavigationTaskStatus.CLOSE_TO_OBSTACLE: 7>
